...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = r"D:\Metro_Safety_Monitor\classification_door_new\ket_qua_option4"        
...
# train toàn bộ network
    ...
    for epoch in range(EPOCH):
        ...
        metrics = [avg_t_loss, avg_v_loss, train_acc, acc, p, r, f1]
    ...
    save_plot(history['train_acc'], 'Train Accuracy (%)', 
          'train_accuracy.png', 'Training Accuracy', 'purple')
    plt.figure(figsize=(10, 6))
